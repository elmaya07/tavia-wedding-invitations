...
const CoverView = (props)=>{
    return(
      <Col  ref={props.myRef1} xs={12} className="d-flex justify-content-center align-items-center h-100"  style={{height:'94%',backgroundImage:`url(${image})`,backgroundRepeat:'no-repeat',backgroundSize:'100% 100%',overflow:'auto '}}>                
          <Row className="h-100 w-100 "  data-aos={props.vis == true ? "fade-right" : "fade-right"}>
            <Col xs={12} className="h-100 w-100 d-flex flex-column justify-content-start align-items-center">
              <Row className="d-flex flex-column flex-2 align-items-center h-100 w-100 ">            
                <Col className="d-flex flex-column flex-1 justify-content-center  ">
                  <span className="wedding-of">THE WEDDING OF</span>                
                </Col>
